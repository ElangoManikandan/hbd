...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date('Jul 4, 2025 00:00:00').getTime(),
...
new TypeIt("#teks1", {
  strings: [
    "Nee Eppavumey Happy a Irukanum..<br>" +
    "You deserve a world of happiness, not just today but always..<br>" +
...
new TypeIt("#teks2", {
  strings: [
    ...
    "Un Police Dream Success Aganum nu Na Vendikuren..<br>" +
    "Keep Smiling always!..<br>" +
    "Appa Amma va pathuko..<br>" +
    "Chellakutty Thangachi ya Pathuko..Enjoy pannu..<br>" +
    "Inniku mattum illa..Ella naalume Jolly a iru..Once again..Many more Happy Returns of the day.. MATHI!  <br>"    +
    "By:  <br>" +
    "ELANGO"
  ],
  startDelay: 2000,
